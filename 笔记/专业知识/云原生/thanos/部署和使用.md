...
thanos 可以在页面直接看到不同压缩层级、不同分辨率的 Block，最小的 Block 就是 Prometheus 上设置的最小时间 min-block-duration
![[Pasted image 20250825101730.png]]
...
// query
 ./dlv1.24 --listen=:2345 --headless=true --api-version=2 --accept-multiclient exec ./thanos query -- --http-address=0.0.0.0:9091 --query.replica-label=replica --store.sd-files=../../store-endpoints.yaml
