...
![image-20210407111503816](https://gitee.com/HappyBinbin/pcigo/raw/master/pic/20210407111503.png)
...
![image-20210407111718472](https://gitee.com/HappyBinbin/pcigo/raw/master/pic/20210407111718.png)
...
![image-20210407111750486](https://gitee.com/HappyBinbin/pcigo/raw/master/pic/20210407111750.png)

## 16.3 获取从服务器信息

当Sentinel发现主服务器有新的从服务器出现时，Sentinel除了会为这个新的从服务器创建相应的实例结构之外，Sentinel还会创建连接到从服务器的命令连接和订阅连接。![image-20210407111829638](https://gitee.com/HappyBinbin/pcigo/raw/master/pic/20210407111829.png)
...
![image-20210407111858212](https://gitee.com/HappyBinbin/pcigo/raw/master/pic/20210407111858.png)
...
![image-20210407112201612](https://gitee.com/HappyBinbin/pcigo/raw/master/pic/20210407112201.png)

假设现在有sentinel1、sentinel2、sentinel3三个Sentinel在监视同一个服务器，那么当sentinel1向服务器的`__sentinel__:hello`频道发送一条信息时，所有订阅了`__sen-tinel__:hello`频道的Sentinel都会收到这条信息。![image-20210407112207533](https://gitee.com/HappyBinbin/pcigo/raw/master/pic/20210407112207.png)
...
当Sentinel通过频道信息发现一个新的Sentinel时，它不仅会为新Sentinel在sentinels字典中创建相应的实例结构**，还会创建一个连向新Sentinel的命令连接**，而**新Sentinel也同样会创建连向这个Sentinel的命令连接**，最终监视同一主服务器的多个Sentinel将形成相互连接的**环形网络**。![image-20210407112347803](https://gitee.com/HappyBinbin/pcigo/raw/master/pic/20210407112347.png)
...
![image-20210407112737615](https://gitee.com/HappyBinbin/pcigo/raw/master/pic/20210407112737.png)
...
之后需要让已下线主服务器属下的所有从服务器去复制新的主服务器，这一动作可以通过向从服务器发送SLAVEOF命令来实现。![image-20210407113051020](https://gitee.com/HappyBinbin/pcigo/raw/master/pic/20210407113051.png)
