...
![img](https://camo.githubusercontent.com/dd7beceb0d08a5bff763f617d0bec8473e5623e057fb6b8b6ba1e8575a738a8b/68747470733a2f2f6275636b65742d313235393535353837302e636f732e61702d6368656e6764752e6d7971636c6f75642e636f6d2f32303230303130323132353732302e706e67)
...
![img](https://camo.githubusercontent.com/ab28447baaf2948b7fc89b363708ec845f7bec9b47f654dbc35a1f5577865e5d/68747470733a2f2f6275636b65742d313235393535353837302e636f732e61702d6368656e6764752e6d7971636c6f75642e636f6d2f32303230303130323133303830322e706e67)
...
下图展示了一个普通状态下（没有rehash）的字典`（真正的字典结构）`

![img](https://camo.githubusercontent.com/6b553fc02d9ef7a4750811b925b1fd2880709fb2147fbf8fc3546641a6a579a0/68747470733a2f2f6275636b65742d313235393535353837302e636f732e61702d6368656e6764752e6d7971636c6f75642e636f6d2f32303230303130323133323432392e706e67)
...
Redis 的哈希表使用链地址法来解决键冲突，并且为了速度考虑，程序总是将新节点添加到链表的表头位置（复杂度为O（1））即头插法
...
- 如果执行扩展操作`ht[1]` 的大小为第一个大于等于 `ht[0].used * 2` 的 2^n，比如原表大小为4，则 `ht[0].used * 2`结果为8，而8刚好是2^3，所以新的大小是8。
...
- 服务器目前没有执行BGSAVE或者BGREWRITEOF命令，并且哈希表的负载因子大于等于1
- 服务器目前正在执行BGSAVE或者BGREWRITEOF命令，并且哈希表的负载因子大于等于5
...
当键值对的数量很多的时候，如果一次性rehash完则可能会导致服务器停止服务一段时间，这是我们不希望看到的。所以，Redis将rehash分多次、渐进式地完成。
